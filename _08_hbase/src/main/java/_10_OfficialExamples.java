...
public class _10_OfficialExamples {
    public static void main(String[] args) throws IOException {
        ...
        // and RegionLocator to find where regions are out on the cluster.
        //
        //
        ...
        try {
            ...
            try {
                ...
                //下面这行报错
                //p.add(Bytes.toBytes("myLittleFamily"), Bytes.toBytes("someQualifier"),Bytes.toBytes("Somevalue"));
