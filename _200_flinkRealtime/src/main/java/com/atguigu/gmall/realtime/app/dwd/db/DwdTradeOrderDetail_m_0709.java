 ...
 */
public class DwdTradeOrderDetail_m_0709 {
    public static void main(String[] args) {
        //TODO 1.基本环境准备
        StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment();
        env.setParallelism(4);
        // 2022/7/9 9:04 NOTE 做关联时才需要设置过期时间, 因为底层要维护状态, 而这里不需要维护底层状态
        ...
        tableEnv.executeSql("create table dwd_trade_order_pre_process(\n" +
            ...
            "row_op_ts timestamp_ltz(3)\n" +
                              // 2022/7/9 9:08 NOTE TODO KafkaUtils
        ...
        tableEnv.executeSql("" +
            ...
            "ts string,\n" +
            "row_op_ts timestamp_ltz(3),\n" +
            "primary key(id) not enforced\n" + // 2022/7/9 9:10 NOTE 使用upersertKafka, 要指定主键
