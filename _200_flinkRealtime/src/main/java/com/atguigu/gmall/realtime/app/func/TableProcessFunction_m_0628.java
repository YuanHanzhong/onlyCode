 ...
 * Desc: 从主流中过滤维度数据
 */
public class TableProcessFunction_m_0628 extends BroadcastProcessFunction<JSONObject, String, JSONObject> {

    private DruidDataSource druidDataSource;

    private final MapStateDescriptor<String, TableProcess> mapStateDescriptor;

    public TableProcessFunction_m_0628(MapStateDescriptor<String, TableProcess> mapStateDescriptor) {
