...
public class _07_Spark_Boolean {
    ...
    public static class Statistics extends KeyedProcessFunction<String, Integer, IntStatistic> {
        ...
        private ValueState<Boolean> isTimed;
        ...
        public void open(Configuration parameters) throws Exception {
            ...
            isTimed = getRuntimeContext().getState(new ValueStateDescriptor<Boolean>(
              "timer",
              Types.BOOLEAN
            ));
