 ...
 *      将生成的业务数据保存到业务数据库中
 *      binlog会记录业务数据库表的变化
 *      maxwell从binlog中读取变化数据并且将变化数据封装为json格式字符串发送给kafka的ODS_BASE_EDU_DB主题
 *      DimApp从ODS_BASE_EDU_DB主题读取数据
...
public class DimApp_m_0716 {
    public static void main(String[] args) throws Exception {
        ...
        //TODO 3.从kafka的ODS_BASE_EDU_DB主题中读取业务数据
        //3.1 声明消费的主题以及消费者组
        ...
        */
        ...
        MySqlSource<String> mySqlSource = MySqlSource.<String>builder()
            .hostname("hadoop102")
            .port(3306)
            .databaseList("education_config")
            .tableList("education_config.table_process")
            .username("root")
            .password("root")
