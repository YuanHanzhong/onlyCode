...
import com.atguigu.gmall.realtime.bean.MyCartAddUuBean;
...
public class DwsTradeCartAddUuWindow {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<JSONObject> processDS = keyedDS.process(
            new KeyedProcessFunction<String, JSONObject, JSONObject>() {
                ...
                public void processElement(JSONObject jsonObj, Context ctx, Collector<JSONObject> out) throws Exception {
                    ...
                    String curCartDate = MyDateFormatUtil.toDate(jsonObj.getLong("ts") * 1000L);
        ...
        //TODO 9.聚合计算
        SingleOutputStreamOperator<MyCartAddUuBean> aggregateDS = windowDS.aggregate(
            ...
            new AllWindowFunction<Long, MyCartAddUuBean, TimeWindow>() {
                @Override
                public void apply(TimeWindow window, Iterable<Long> values, Collector<MyCartAddUuBean> out) throws Exception {
                    for (Long value : values) {
                        out.collect(new MyCartAddUuBean(
